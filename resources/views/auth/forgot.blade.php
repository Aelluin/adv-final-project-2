...
<head>
  ...
  <title>Bloggit Forgot Page</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Bloggit</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0" style ="margin-top: 20px;"><a href="{{url('register')}}">Register a new account?</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://renceramrz.netlify.app/">Laurence Ramirez</a>
              </div>
